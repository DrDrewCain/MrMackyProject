    ...
    <div className="bg-grey px-4 py-6">
      <p className="mt-6 animate-fade-down text-gray-500">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Mr Macky&apos;s HR Simulation.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Mr Macky&apos;s HR Simulation,
              accessible from
              <a
                href="https://www.simulation.sturman.org"
                rel="noopener noreferrer"
                target="_blank"
              >
                https://www.simulation.sturman.org
              </a>
            </p>
          </li>
          <li>
        ...
        <p>
          ...
          close Your web browser. You can learn more about cookies on the
          <a
        ...
        <ul>
          <li>By email: hrsimulation@sturman.org</li>
        </ul>
      </p>
    </div>
  );
